...
$lang = array(
    ...
    "NÃ£o tem permissÃ£o para enviar ficheiros.",

    "You don't have permissions to browse server." =>
    "NÃ£o tem permissÃ£o para navegar no servidor.",

    "Cannot move uploaded file to target folder." =>
    "NÃ£o pode mover ficheiros enviados para a pasta definida.",
    ...
    "Falta a pasta temporÃ¡ria.",

    "Failed to write file." =>
    "NÃ£o foi possÃvel guardar o ficheiro.",

    "Denied file extension." =>
    "ExtensÃ£o do ficheiro invÃ¡lida.",

    "Unknown image format/encoding." =>
    "Formato/codificaÃ§Ã£o da imagem desconhecido.",

    "The image is too big and/or cannot be resized." =>
    "A imagem Ã© muito grande e nÃ£o pode ser redimensionada.",

    "Cannot create {dir} folder." =>
    "NÃ£o foi possÃvel criar a pasta '{dir}'.",

    "Cannot write to upload folder." =>
    "NÃ£o foi possÃvel guardar o ficheiro.",

    "Cannot read .htaccess" =>
    "NÃ£o foi possÃvel ler o ficheiro '.htaccess'.",

    "Incorrect .htaccess file. Cannot rewrite it!" =>
    "Ficheiro '.htaccess' incorrecto. NÃ£o foi possÃvel altera-lo.",

    "Cannot read upload folder." =>
    "NÃ£o foi possÃvel ler a pasta de upload.",

    "Cannot access or create thumbnails folder." =>
    "NÃ£o foi possÃvel aceder ou criar a pasta de miniaturas.",

    "Cannot access or write to upload folder." =>
    "NÃ£o foi possÃvel aceder ou criar a pasta de upload.",

    "Please enter new folder name." =>
    "Por favor insira o nome da pasta.",

    "Unallowable characters in folder name." =>
    "Caracteres nÃ£o autorizados no nome da pasta.",

    "Folder name shouldn't begins with '.'" =>
    "O nome da pasta nÃ£o deve começar por '.'.",

    "Please enter new file name." =>
    "Por favor defina o nome do ficheiro.",

    "Unallowable characters in file name." =>
    "Caracteres nÃ£o autorizados no nome do ficheiro.",

    "File name shouldn't begins with '.'" =>
    "O nome do ficheiro nÃ£o deve começar por '.'.",

    "Are you sure you want to delete this file?" =>
    "Tem a certeza que deseja apagar este ficheiro?",

    "Are you sure you want to delete this folder and all its content?" =>
    "Tem a certeza que deseja apagar esta pasta e todos os seus conteÃºdos?",
    ...
    "Falta a extensÃ£o PECL nas informaÃ§Ãµes do ficheiro.",

    "Opening fileinfo database failed." =>
    "Erro a abrir a informaÃ§Ã£o do ficheiro.",

    "You can't upload such files." =>
    "NÃ£o pode enviar esse tipo de ficheiros.",

    "The file '{file}' does not exist." =>
    "O ficheiro '{file}' nÃ£o existe.",

    "Cannot read '{file}'." =>
    "NÃ£o pode ler '{file}'.",

    "Cannot copy '{file}'." =>
    "NÃ£o pode copiar '{file}'.",

    "Cannot move '{file}'." =>
    "NÃ£o pode mover '{file}'.",

    "Cannot delete '{file}'." =>
    "NÃ£o pode apagar '{file}'.",

    "Click to remove from the Clipboard" =>
    "Clique aqui para remover do Clipboard",

    "This file is already added to the Clipboard." =>
    "Este ficheiros jÃ¡ foi adicionado ao Clipboard.",
    ...
    "Tem a certeza que deseja apagar todos os ficheiros que estÃ£o no Clipboard?",
    ...
    "NÃ£o pode alterar o nome da pasta.",

    "Non-existing directory type." =>
    "Tipo de pasta inexistente.",

    "Cannot delete the folder." =>
    "NÃ£o pode apagar a pasta.",

    "The files in the Clipboard are not readable." =>
    "Os ficheiros que estÃ£o no Clipboard nÃ£o podem ser copiados.",

    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" =>
    "{count} ficheiros do Clipboard nÃ£o podem ser copiados. Pretende copiar os restantes?",

    "The files in the Clipboard are not movable." =>
    "Os ficheiros que estÃ£o no Clipboard nÃ£o podem ser movidos.",

    "{count} files in the Clipboard are not movable. Do you want to move the rest?" =>
    "{count} ficheiros do Clipboard nÃ£o podem ser movidos. Pretende mover os restantes?",

    "The files in the Clipboard are not removable." =>
    "Os ficheiros que estÃ£o no Clipboard nÃ£o podem ser removidos.",

    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" =>
    "{count} ficheiros do Clipboard nÃ£o podem ser removidos. Pretende apagar os restantes?",

    "The selected files are not removable." =>
    "Os ficheiros seleccionados nÃ£o podem ser removidos.",

    "{count} selected files are not removable. Do you want to delete the rest?" =>
    "NÃ£o pode remover {count} ficheiros. Pretende apagar os restantes?",
    ...
    "JÃ¡ existe um ficheiro ou pasta com esse nome.",
